...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-01-2018 a las 00:49:54
...
--
ALTER TABLE `tipo_documento`
  MODIFY `codTipoDocumento` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `telefono`
  ADD CONSTRAINT `R_1` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);
