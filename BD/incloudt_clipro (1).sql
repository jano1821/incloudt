...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-01-2018 a las 00:54:59
...
INSERT INTO `departamento` (`codDepartamento`, `nombreDepartamento`) VALUES
(1, 'AMAZONAS'),
(2, 'ANCASH'),
(3, 'APURIMAC'),
(4, 'AREQUIPA'),
...
INSERT INTO `distrito` (`codDistrito`, `nombreDistrito`, `codProvincia`) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
...
CREATE TABLE `telefono` (
  ...
  `numeroTelefono` varchar(40) DEFAULT NULL,
  `codPersona` int(11) NOT NULL,
  `codOperador` int(11) NOT NULL,
  `estadoRegistro` varchar(1) DEFAULT NULL,
  `usuarioInsercion` varchar(1) DEFAULT NULL,
  `fechaInsercion` datetime DEFAULT NULL,
  `usuarioModificacion` varchar(1) DEFAULT NULL,
  `fechaModificacion` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tipo_documento` (
  `codTipoDocumento` int(11) NOT NULL,
  `descripcionTipoDocumento` varchar(250) DEFAULT NULL,
  `estadoRegistro` varchar(1) DEFAULT NULL,
  `usuarioInsercion` varchar(30) DEFAULT NULL,
  `fechaInsercion` datetime DEFAULT NULL,
  `usuarioModificacion` varchar(30) DEFAULT NULL,
...
INSERT INTO `tipo_documento` (`codTipoDocumento`, `descripcionTipoDocumento`, `estadoRegistro`, `usuarioInsercion`, `fechaInsercion`, `usuarioModificacion`, `fechaModificacion`) VALUES
(1, 'DNI', 'S', 'jano', '2018-01-08 00:00:00', 'acnunez', '2018-01-10 00:00:00'),
(2, 'RUC', 'S', 'jano', '2018-01-09 00:00:00', NULL, NULL),
(8, 'Carné de Extranjería', 'S', 'acnunez', '2018-01-10 00:00:00', NULL, NULL),
(9, 'Partida de Nacimiento', 'S', 'acnunez', '2018-01-10 00:00:00', NULL, NULL);
...
ALTER TABLE `direccion`
  ...
  ADD KEY `R_2` (`codPersona`),
  ADD KEY `R_8` (`codDistrito`);
...
--
ALTER TABLE `departamento`
  MODIFY `codDepartamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `distrito`
  MODIFY `codDistrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1832;
--
-- AUTO_INCREMENT de la tabla `operador`
--
ALTER TABLE `operador`
  MODIFY `codOperador` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `provincia`
  MODIFY `codProvincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
--
-- AUTO_INCREMENT de la tabla `telefono`
--
ALTER TABLE `telefono`
  MODIFY `codTelefono` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipo_documento`
--
ALTER TABLE `tipo_documento`
  MODIFY `codTipoDocumento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `R_5` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `R_2` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`),
  ADD CONSTRAINT `R_8` FOREIGN KEY (`codDistrito`) REFERENCES `distrito` (`codDistrito`);

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `R_7` FOREIGN KEY (`codProvincia`) REFERENCES `provincia` (`codProvincia`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `R_3` FOREIGN KEY (`codTipoDocumento`) REFERENCES `tipo_documento` (`codTipoDocumento`);

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `R_4` FOREIGN KEY (`codPersona`) REFERENCES `persona` (`codPersona`);

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `R_6` FOREIGN KEY (`codDepartamento`) REFERENCES `departamento` (`codDepartamento`);

--
-- Filtros para la tabla `telefono`
--
ALTER TABLE `telefono`
  ADD CONSTRAINT `R_9` FOREIGN KEY (`codOperador`) REFERENCES `operador` (`codOperador`);
