...
<?= $this->tag->linkTo(['usuario_sistema', '<i class=\'glyphicon glyphicon-chevron-left\'></i> Volver a Búsqueda', 'class' => 'btn btn-info']) ?>
        </div>
...
<?= $this->tag->form(['usuario_sistema/create', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
