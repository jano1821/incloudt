...
<div class="btn-group pull-right">
        <?= $this->tag->linkTo(['persona_usuario', '<i class=\'glyphicon glyphicon-chevron-left\'></i> Volver', 'class' => 'btn btn-info']) ?>
</div>
...
<?= $this->tag->form(['persona_usuario/save', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
...
<?= $this->tag->hiddenField(['codPersonaUsuario']) ?>
